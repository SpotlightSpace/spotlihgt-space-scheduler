package com.sparta.spotlightspacescheduler.core.payment.constant;
...
public abstract class PaymentConstant {
    ...
    public static final String PAYMENT_STATUS_URL = "https://open-api.kakaopay.com/online/v1/payment/order";
}
